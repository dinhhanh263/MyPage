	...
	<main class="container" id="change_rsv">
		<section class="main">
			<div class="main-content">
				...
				<div class="phase-step"><img src="{{ asset('img/phase-chg-step2.png') }}" alt="検索結果"></div>
				<div class="box">
				...
				<div class="mainTxtArea pt-30">
					<form method="get" action="{{ route('mypageReserveChange', ['contract_id' => $ary_change_data['contractId'], 'reservation_id' => $ary_change_data['reservationId']]) }}">
								...
								@foreach ($val as $time_cd => $reserve_info)
									<tr align="CENTER" valign="MIDDLE">
										...
										@foreach ($reserve_info as $shop_id_sub => $value)
											...
											@else
												<td>
													<span style="cursor: pointer" onclick="pushConfirm(2, '{{ $key }}', {{ $shop_id_sub }}, {{ $time_cd }});">◯</span>
												</td>
											@endif
