...
@section('content')
	<main class="container main-container" id="change_rsv">
		<section class="main">
			<div class="main-content">
				<div class="page-title">
					<h1 class="title">ご予約の変更</h1>
				</div>
				<div class="phase-step"><img src="{{ asset('img/phase-chg-step4.png') }}" alt="変更内容確定"></div>
				<h2 class="stepBar pt-30">変更内容確定</h2>
